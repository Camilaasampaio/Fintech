...
<body>
	...
	<div class="container">
		...
		<div class="py-5 text-center">
			<img src="resources/imagens/meusganhos.jpg"
				class="d-block mx-auto mb-4" alt="" width="400" height="300">
			<h2>Meus Ganhos</h2>
			<p class="lead">Aqui você irá cadastrar os seus ganhos, como por
				exemplo um Pix que recebeu, o pagamento da empresa e assim por diante...</p>
		</div>
		<!-- Formulário -->
		<div class="col-md-12 col-lg-12">
			<h4 class="mb-3">Cadastre seus ganhos</h4>
